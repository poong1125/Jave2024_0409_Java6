	...
	private JTabbedPane getJTabbedPane() {
		...
		private JPanel getTab1Panel() {
			if(tab1Panel == null) {
				...
				jLabel.setIcon(new ImageIcon(getClass().getResource("../bin./d0412_pdf92page/siuu.jpeg")));
		...
		private JPanel getTab2Panel() {
			if(tab2Panel == null) {
				...
				JLabel jLabel = new JLabel();
				jLabel.setIcon(new ImageIcon(getClass().getResource("../bin./d0412_pdf92page/MeJ.jpg")));
